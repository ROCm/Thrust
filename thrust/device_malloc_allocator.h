 ...
 */
    ...
    public:
        ...
        /*! The \p rebind metafunction provides the type of a \p
   * device_malloc_allocator instantiated with another type.
   *
   ...
   */
        ...
        struct rebind
        {
            /*! The typedef \p other gives the type of the rebound \p
   ...
   *  \note Memory allocated by this function must be deallocated with \p
   * deallocate.
   */
        __host__ inline pointer allocate(size_type cnt,
   ...
   */
        ...
        {
            // silence unused parameter warning while still leaving the parameter name
            // for Doxygen
            (void)(cnt);
        ...
        /*! Returns the largest value \c n for which <tt>allocate(n)</tt> might
   * succeed. \return The largest value \c n for which <tt>allocate(n)</tt>
   * might succeed.
   */
   ...
   *  \return \c true
   */
        __host__ __device__ inline bool operator==(device_malloc_allocator const&)
        {
            return true;
        }
   ...
   *  \return \c false
   */
        __host__ __device__ inline bool operator!=(device_malloc_allocator const& a)
        {
            return !operator==(a);
        }
