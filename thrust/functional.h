 ...
 */
    ...
    /*! \p plus is a function object. Specifically, it is an Adaptable Binary
 * Function. If \c f is an object of class <tt>plus<T></tt>, and \c x and \c y
 * are objects of class \c T, then <tt>f(x,y)</tt> returns <tt>x+y</tt>.
 *
 *  \tparam T is a model of <a
 * href="http://www.sgi.com/tech/stl/Assignable.html">Assignable</a>, and if \c
 * x and \c y are objects of type \p T, then <tt>x+y</tt> must be defined and
 * must have a return type that is convertible to \c T.
 *
 ...
 */
   ...
   */
    ...
    /*! \p minus is a function object. Specifically, it is an Adaptable Binary
 * Function. If \c f is an object of class <tt>minus<T></tt>, and \c x and \c y
 * are objects of class \c T, then <tt>f(x,y)</tt> returns <tt>x-y</tt>.
 *
 *  \tparam T is a model of <a
 * href="http://www.sgi.com/tech/stl/Assignable.html">Assignable</a>, and if \c
 ...
 * must have a return type that is convertible to \c T.
 *
 *  The following code snippet demonstrates how to use <tt>minus</tt> to
 * subtract a device_vector of \c floats from another.
 *
 *  \code
 *  #include <thrust/device_vector.h>
 *  #include <thrust/functional.h>
 ...
 */
   ...
   */
    ...
    /*! \p multiplies is a function object. Specifically, it is an Adaptable Binary
 * Function. If \c f is an object of class <tt>minus<T></tt>, and \c x and \c y
 * are objects of class \c T, then <tt>f(x,y)</tt> returns <tt>x*y</tt>.
 *
 *  \tparam T is a model of <a
 ...
 * must have a return type that is convertible to \c T.
 *
 *  The following code snippet demonstrates how to use <tt>multiplies</tt> to
 * multiply two device_vectors of \c floats.
 *
 *  \code
 *  #include <thrust/device_vector.h>
 *  #include <thrust/functional.h>
 ...
 */
   ...
   */
    ...
    /*! \p divides is a function object. Specifically, it is an Adaptable Binary
 * Function. If \c f is an object of class <tt>divides<T></tt>, and \c x and \c
 * y are objects of class \c T, then <tt>f(x,y)</tt> returns <tt>x/y</tt>.
 *
 *  \tparam T is a model of <a
 * href="http://www.sgi.com/tech/stl/Assignable.html">Assignable</a>, and if \c
 * x and \c y are objects of type \p T, then <tt>x/y</tt> must be defined and
 * must have a return type that is convertible to \c T.
 *
 *  The following code snippet demonstrates how to use <tt>divides</tt> to
 * divide one device_vectors of \c floats by another.
 *
 *  \code
 *  #include <thrust/device_vector.h>
 *  #include <thrust/functional.h>
 ...
 */
   ...
   */
    ...
    /*! \p modulus is a function object. Specifically, it is an Adaptable Binary
 * Function. If \c f is an object of class <tt>modulus<T></tt>, and \c x and \c
 * y are objects of class \c T, then <tt>f(x,y)</tt> returns <tt>x \% y</tt>.
 *
 *  \tparam T is a model of <a
 * href="http://www.sgi.com/tech/stl/Assignable.html">Assignable</a>, and if \c
 ...
 */
   ...
   */
    ...
    /*! \p negate is a function object. Specifically, it is an Adaptable Unary
 * Function. If \c f is an object of class <tt>negate<T></tt>, and \c x is an
 * object of class \c T, then <tt>f(x)</tt> returns <tt>-x</tt>.
 *
 *  \tparam T is a model of <a
 * href="http://www.sgi.com/tech/stl/Assignable.html">Assignable</a>, and if \c
 * x is an object of type \p T, then <tt>-x</tt> must be defined and must have a
 * return type that is convertible to \c T.
 *
 ...
 *  Predicate, which means it is a function object that tests the truth or
 * falsehood of some condition. If \c f is an object of class
 * <tt>equal_to<T></tt> and \c x and \c y are objects of class \c T, then
 * <tt>f(x,y)</tt> returns \c true if <tt>x == y</tt> and \c false otherwise.
 *
 *  \tparam T is a model of <a
 ...
 */
   ...
   */
    ...
    /*! \p not_equal_to is a function object. Specifically, it is an Adaptable
 * Binary Predicate, which means it is a function object that tests the truth or
 * falsehood of some condition. If \c f is an object of class
 * <tt>not_equal_to<T></tt> and \c x and \c y are objects of class \c T, then
 * <tt>f(x,y)</tt> returns \c true if <tt>x != y</tt> and \c false otherwise.
 *
 *  \tparam T is a model of <a
 * href="http://www.sgi.com/tech/stl/EqualityComparable.html">Equality
 ...
 *  Predicate, which means it is a function object that tests the truth or
 * falsehood of some condition. If \c f is an object of class
 * <tt>greater<T></tt> and \c x and \c y are objects of class \c T, then
 * <tt>f(x,y)</tt> returns \c true if <tt>x > y</tt> and \c false otherwise.
 *
 *  \tparam T is a model of <a
 * href="http://www.sgi.com/tech/stl/LessThanComparable.html">LessThan
 * Comparable</a>.
 *
 ...
 *  Predicate, which means it is a function object that tests the truth or
 * falsehood of some condition. If \c f is an object of class <tt>less<T></tt>
 * and \c x and \c y are objects of class \c T, then <tt>f(x,y)</tt> returns \c
 * true if <tt>x < y</tt> and \c false otherwise.
 *
 *  \tparam T is a model of <a
 * href="http://www.sgi.com/tech/stl/LessThanComparable.html">LessThan
 * Comparable</a>.
 ...
 */
   ...
   */
    ...
    /*! \p greater_equal is a function object. Specifically, it is an Adaptable
 * Binary Predicate, which means it is a function object that tests the truth or
 * falsehood of some condition. If \c f is an object of class
 * <tt>greater_equal<T></tt> and \c x and \c y are objects of class \c T, then
 * <tt>f(x,y)</tt> returns \c true if <tt>x >= y</tt> and \c false otherwise.
 *
 *  \tparam T is a model of <a
 * href="http://www.sgi.com/tech/stl/LessThanComparable.html">LessThan
 ...
 *  Predicate, which means it is a function object that tests the truth or
 * falsehood of some condition. If \c f is an object of class
 * <tt>less_equal<T></tt> and \c x and \c y are objects of class \c T, then
 * <tt>f(x,y)</tt> returns \c true if <tt>x <= y</tt> and \c false otherwise.
 *
 *  \tparam T is a model of <a
 * href="http://www.sgi.com/tech/stl/LessThanComparable.html">LessThan
 ...
 */
    ...
    /*! \p logical_and is a function object. Specifically, it is an Adaptable Binary
 * Predicate, which means it is a function object that tests the truth or
 * falsehood of some condition. If \c f is an object of class
 * <tt>logical_and<T></tt> and \c x and \c y are objects of class \c T (where \c
 * T is convertible to \c bool) then <tt>f(x,y)</tt> returns \c true if and only
 * if both \c x and \c y are \c true.
 *
 ...
 */
   ...
   */
    ...
    /*! \p logical_or is a function object. Specifically, it is an Adaptable Binary
 * Predicate, which means it is a function object that tests the truth or
 * falsehood of some condition. If \c f is an object of class
 * <tt>logical_or<T></tt> and \c x and \c y are objects of class \c T (where \c
 * T is convertible to \c bool) then <tt>f(x,y)</tt> returns \c true if and only
 * if either \c x or \c y are \c true.
 *
 *  \tparam T must be convertible to \c bool.
 *
 ...
 */
   ...
   */
    ...
    /*! \p logical_not is a function object. Specifically, it is an Adaptable
 * Predicate, which means it is a function object that tests the truth or
 * falsehood of some condition. If \c f is an object of class
 * <tt>logical_not<T></tt> and \c x is an object of class \c T (where \c T is
 * convertible to \c bool) then <tt>f(x)</tt> returns \c true if and only if \c
 * x is \c false.
 *
 *  \tparam T must be convertible to \c bool.
 *
 *  The following code snippet demonstrates how to use \p logical_not to
 * transform a device_vector of \c bools into its logical complement.
 *
 *  \code
 *  #include <thrust/device_vector.h>
 *  #include <thrust/transform.h>
 ...
 */
    ...
    /*! \p bit_and is a function object. Specifically, it is an Adaptable Binary
 * Function. If \c f is an object of class <tt>bit_and<T></tt>, and \c x and \c
 * y are objects of class \c T, then <tt>f(x,y)</tt> returns <tt>x&y</tt>.
 *
 *  \tparam T is a model of <a
 * href="http://www.sgi.com/tech/stl/Assignable.html">Assignable</a>, and if \c
 ...
 */
   ...
   */
    ...
    /*! \p bit_or is a function object. Specifically, it is an Adaptable Binary
 * Function. If \c f is an object of class <tt>bit_and<T></tt>, and \c x and \c
 * y are objects of class \c T, then <tt>f(x,y)</tt> returns <tt>x|y</tt>.
 *
 *  \tparam T is a model of <a
 ...
 */
   ...
   */
    ...
    /*! \p bit_xor is a function object. Specifically, it is an Adaptable Binary
 * Function. If \c f is an object of class <tt>bit_and<T></tt>, and \c x and \c
 * y are objects of class \c T, then <tt>f(x,y)</tt> returns <tt>x^y</tt>.
 *
 *  \tparam T is a model of <a
 ...
 */
    ...
    /*! \p identity is a Unary Function that represents the identity function: it
 * takes a single argument \c x, and returns \c x.
 *
 ...
 */
   ...
   */
    ...
    /*! \p maximum is a function object that takes two arguments and returns the
 * greater of the two. Specifically, it is an Adaptable Binary Function. If \c f
 * is an object of class <tt>maximum<T></tt> and \c x and \c y are objects of
 * class \c T <tt>f(x,y)</tt> returns \c x if <tt>x > y</tt> and \c y,
 * otherwise.
 *
 *  \tparam T is a model of <a
 * href="http://www.sgi.com/tech/stl/LessThanComparable.html">LessThan
 ...
 */
   ...
   */
        ...
        /*! Function call operator. The return value is <tt>rhs < lhs ? lhs :
   * rhs</tt>.
   */
        __host__ __device__ T operator()(const T& lhs, const T& rhs) const
        {
    ...
    /*! \p minimum is a function object that takes two arguments and returns the
 * lesser of the two. Specifically, it is an Adaptable Binary Function. If \c f
 * is an object of class <tt>minimum<T></tt> and \c x and \c y are objects of
 * class \c T <tt>f(x,y)</tt> returns \c x if <tt>x < y</tt> and \c y,
 * otherwise.
 *
 *  \tparam T is a model of <a
 ...
 */
   ...
   */
        ...
        /*! Function call operator. The return value is <tt>lhs < rhs ? lhs :
   * rhs</tt>.
   */
        __host__ __device__ T operator()(const T& lhs, const T& rhs) const
        {
 ...
 *  That is: if \c f is an object of class
 * <tt>unary_negate<AdaptablePredicate></tt>, then there exists an object \c
 * pred of class \c AdaptablePredicate such that <tt>f(x)</tt> always returns
 * the same value as <tt>!pred(x)</tt>. There is rarely any reason to construct
 * a <tt>unary_negate</tt> directly; it is almost always easier to use the
 * helper function not1.
 *
 ...
 */
   ...
   */
    ...
    /*! \p not1 is a helper function to simplify the creation of Adaptable
 * Predicates: it takes an Adaptable Predicate \p pred as an argument and
 * returns a new Adaptable Predicate that represents the negation of \p pred.
 * That is: if \c pred is an object of a type which models Adaptable Predicate,
 * then the the type of the result \c npred of <tt>not1(pred)</tt> is also a
 * model of Adaptable Predicate and <tt>npred(x)</tt> always returns the same
 * value as <tt>!pred(x)</tt>.
 *
 *  \param pred The Adaptable Predicate to negate.
 *  \return A new object, <tt>npred</tt> such that <tt>npred(x)</tt> always
 * returns the same value as <tt>!pred(x)</tt>.
 *
 *  \tparam Predicate is a model of <a
 * href="http://www.sgi.com/tech/stl/AdaptablePredicate.html">Adaptable
 * Predicate</a>.
 *
 *  \see unary_negate
 *  \see not2
 ...
 *  Binary Predicate. That is: if \c f is an object of class
 * <tt>binary_negate<AdaptablePredicate></tt>, then there exists an object \c
 * pred of class \c AdaptableBinaryPredicate such that <tt>f(x,y)</tt> always
 * returns the same value as <tt>!pred(x,y)</tt>. There is rarely any reason to
 * construct a <tt>binary_negate</tt> directly; it is almost always easier to
 * use the helper function not2.
 *
 ...
 */
   ...
   */
    ...
    /*! \p not2 is a helper function to simplify the creation of Adaptable Binary
 * Predicates: it takes an Adaptable Binary Predicate \p pred as an argument and
 * returns a new Adaptable Binary Predicate that represents the negation of \p
 * pred. That is: if \c pred is an object of a type which models Adaptable
 * Binary Predicate, then the the type of the result \c npred of
 * <tt>not2(pred)</tt> is also a model of Adaptable Binary Predicate and
 *  <tt>npred(x,y)</tt> always returns the same value as <tt>!pred(x,y)</tt>.
 *
 *  \param pred The Adaptable Binary Predicate to negate.
 *  \return A new object, <tt>npred</tt> such that <tt>npred(x,y)</tt> always
 * returns the same value as <tt>!pred(x,y)</tt>.
 *
 ...
 *
 *  Objects in the \p thrust::placeholders namespace may be used to create
 * simple arithmetic functions inline in an algorithm invocation. Combining
 * placeholders such as \p _1 and \p _2 with arithmetic operations such as \c +
 *  creates an unnamed function object which applies the operation to their
 * arguments.
 *
 *  The type of placeholder objects is implementation-defined.
 *
 *  The following code snippet demonstrates how to use the placeholders \p _1
 * and \p _2 with \p thrust::transform to implement the SAXPY computation:
 *
 *  \code
 *  #include <thrust/device_vector.h>
 *  #include <thrust/transform.h>
...
/*! \p thrust::placeholders::_1 is the placeholder for the first function
 * parameter.
 */
//#ifdef __CUDA_ARCH_
...
/*! \p thrust::placeholders::_2 is the placeholder for the second function
 * parameter.
 */
//#ifdef __CUDA_ARCH__
#if __HIP_DEVICE_COMPILE__
...
/*! \p thrust::placeholders::_3 is the placeholder for the third function
 * parameter.
 */
//#ifdef __CUDA_ARCH__
#if __HIP_DEVICE_COMPILE__
...
/*! \p thrust::placeholders::_4 is the placeholder for the fourth function
 * parameter.
 */
//#ifdef __CUDA_ARCH__
#if __HIP_DEVICE_COMPILE__
...
/*! \p thrust::placeholders::_5 is the placeholder for the fifth function
 * parameter.
 */
//#ifdef __CUDA_ARCH__
#if __HIP_DEVICE_COMPILE__
...
/*! \p thrust::placeholders::_6 is the placeholder for the sixth function
 * parameter.
 */
//#ifdef __CUDA_ARCH__
#if __HIP_DEVICE_COMPILE__
...
/*! \p thrust::placeholders::_7 is the placeholder for the seventh function
 * parameter.
 */
//#ifdef __CUDA_ARCH__
#if __HIP_DEVICE_COMPILE__
...
/*! \p thrust::placeholders::_8 is the placeholder for the eighth function
 * parameter.
 */
//#ifdef __CUDA_ARCH__
#if __HIP_DEVICE_COMPILE__
...
/*! \p thrust::placeholders::_9 is the placeholder for the ninth function
 * parameter.
 */
//#ifdef __CUDA_ARCH__
#if __HIP_DEVICE_COMPILE__
...
/*! \p thrust::placeholders::_10 is the placeholder for the tenth function
 * parameter.
 */
//#ifdef __CUDA_ARCH__
#if __HIP_DEVICE_COMPILE__
