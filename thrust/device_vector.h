 ...
 *  \brief A dynamically-sizable array of elements which reside in the "device"
 * memory space
 */
 ...
 * memory space of a parallel device.
 *
 ...
 */
   ...
   */
        __host__ explicit device_vector(size_type n)
            : Parent(n)
        {
        }
   ...
   */
        __host__ explicit device_vector(size_type n, const value_type& value)
            : Parent(n, value)
        {
        }
   ...
   */
        __host__ device_vector(device_vector&& v)
            : Parent(std::move(v))
        {
        }
#endif
   ...
   *  \param v The \p device_vector to copy.
   */
        __host__ device_vector& operator=(const device_vector& v)
        {
            Parent::operator=(v);
            return *this;
        }
   ...
   *  \param v The device_vector to move.
   */
        __host__ device_vector& operator=(device_vector&& v)
        {
        ...
        /*! Copy constructor copies from an exemplar \p device_vector with different
   * type. \param v The \p device_vector to copy.
   */
        ...
        /*! Assign operator copies from an exemplar \p device_vector with different
   * type. \param v The \p device_vector to copy.
   */
        template <typename OtherT, typename OtherAlloc>
   ...
   */
        ...
        /*! Copy constructor copies from an exemplar \p host_vector with possibly
   * different type. \param v The \p host_vector to copy.
   */
        template <typename OtherT, typename OtherAlloc>
   ...
   */
        template <typename OtherT, typename OtherAlloc>
        __host__ device_vector& operator=(const host_vector<OtherT, OtherAlloc>& v)
        {
            Parent::operator=(v);
            return *this;
        }
