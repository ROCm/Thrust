 ...
 */
        ...
        /*! \brief The class \p system_error describes an exception object used to
 * report error conditions that have an associated \p error_code. Such error
 * conditions typically originate from the operating system or other low-level
 * application program interfaces.
 *
 *  Thrust uses \p system_error to report the error codes returned from device
 * backends such as the CUDA runtime.
 *
 *  The following code listing demonstrates how to catch a \p system_error to
 ...
 *  \endcode
 *
 *  \note If an error represents an out-of-memory condition, implementations are
 * encouraged to throw an exception object of type \p std::bad_alloc rather than
 * \p system_error.
 */
