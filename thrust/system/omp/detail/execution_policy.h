    ...
    namespace system
    {
        ...
        namespace omp
        {
            namespace detail
            {
                ...
                inline __host__ __device__ System1
                                           select_system(execution_policy<System1> s,
                                                         thrust::system::tbb::detail::execution_policy<System2>)
                {
                    return thrust::detail::derived_cast(s);
                } // end select_system()

                template <typename System1, typename System2>
                inline __host__ __device__ System2
                                           select_system(thrust::system::tbb::detail::execution_policy<System1>,
                                                         execution_policy<System2> s)
                {
                    return thrust::detail::derived_cast(s);
                } // end select_system()
