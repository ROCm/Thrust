 ...
 *  \brief A dynamically-sizable array of elements which reside in memory
 * available to Thrust's standard C++ system.
 */
...
namespace thrust
{
    ...
    namespace system
    {
        namespace cpp
        {
            ...
            // XXX upon c++11
            // template<typename T, typename Allocator = allocator<T> > using vector =
            // thrust::detail::vector_base<T,Allocator>;
 ...
 *  \tparam Allocator The allocator type of the \p cpp::vector. Defaults to \p
 * cpp::allocator.
 *
 ...
 */
   ...
   */
                ...
                /*! This constructor creates a \p cpp::vector with \p n default-constructed
   * elements. \param n The size of the \p cpp::vector to create.
   */
   ...
   */
                ...
                // XXX vector_base should take a Derived type so we don't have to define these
                // superfluous assigns
