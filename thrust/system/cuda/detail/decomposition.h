        ...
        namespace cuda
        {
            namespace detail
            {
                ...
                public:
                    ...
                    __host__ __device__ trivial_decomposition()
                        : m_n(0)
                    {
                    }

                    __host__ __device__ trivial_decomposition(size_type n)
                        : m_n(n)
                    {
                    }

                    __host__ __device__ range operator[](size_type) const
                    {
                        return range(0, n());
                    }
                    ...
                    __host__ __device__ size_type n() const
                    {
                        return m_n;
                    }
                ...
                template <typename Size>
                __host__ __device__ trivial_decomposition<Size> make_trivial_decomposition(Size n)
                {
                ...
                public:
                    ...
                    __host__ __device__ blocked_decomposition()
                        : m_n(0)
                        , m_block_size(0)
                        , m_num_partitions(0)
                    {
                    ...
                    __host__ __device__ blocked_decomposition(size_type n, Size block_size)
                        : m_n(n)
                    ...
                    __host__ __device__ range operator[](size_type i) const
                    {
                ...
                template <typename Size>
                __host__ __device__ blocked_decomposition<Size>
                ...
                public:
                    __host__ __device__ uniform_decomposition()
                        : super_t()
                    {
                    }

                    __host__ __device__ uniform_decomposition(Size n, Size num_partitions)
                ...
                template <typename Size>
                __host__ __device__ uniform_decomposition<Size>
                ...
                public:
                    ...
                    __host__ __device__ aligned_decomposition()
                        : m_n(0)
                        , m_num_partitions(0)
                        , m_tile_size(0)
                    {
                    ...
                    __host__ __device__ aligned_decomposition(Size n,
                                                              Size num_partitions,
                                                              Size aligned_size)
                        : m_n(n)
                    ...
                    __host__ __device__ range operator[](Size i) const
                    {
                ...
                private:
                    __host__ __device__ range range_in_tiles(size_type i) const
                    {
                        range result;
                        ...
                        result.second = result.first + m_num_tiles_per_partition
                                        + (i < m_last_partial_tile_size);
                ...
                template <typename Size>
                __host__ __device__ aligned_decomposition<Size>
