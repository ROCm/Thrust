...
//     symbols resulting from assign_value
                ...
                namespace
                {
                    ...
                    inline __host__ __device__ void assign_value_msvc2005_war(
                        thrust::cuda::execution_policy<DerivedPolicy>& exec,
                        Pointer1                                       dst,
                        Pointer2                                       src)
                    {
                        ...
                        struct war_nvbugs_881631
                        {
                            __host__ inline static void
                                host_path(thrust::cuda::execution_policy<DerivedPolicy>& exec,
                                          Pointer1                                       dst,
                                          Pointer2                                       src)
                            {
                            ...
                            __device__ inline static void
                                device_path(thrust::cuda::execution_policy<DerivedPolicy>&,
                                            Pointer1 dst,
                                            Pointer2 src)
                            {
...
//     symbols resulting from assign_value
                ...
                namespace
                {
                    ...
                    template <typename System1,
                              ...
                              typename Pointer2>
                    inline __host__ __device__ void assign_value_msvc2005_war(
                        cross_system<System1, System2>& systems, Pointer1 dst, Pointer2 src)
                    {
                        // XXX war nvbugs/881631
                        struct war_nvbugs_881631
                        {
