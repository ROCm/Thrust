        ...
        namespace cuda
        {
            namespace detail
            {
                namespace detail
                {
                    ...
                    template <unsigned int result_size_bound,
                              typename Iterator1,
                              typename Iterator2,
                              typename Iterator3,
                              typename Compare>
                    __device__ void sequential_bounded_merge(Iterator1 first1,
                                                             Iterator1 last1,
                                                             Iterator2 first2,
                                                             Iterator2 last2,
                                                             Iterator3 result,
                                                             Compare   comp)
                    {
                        ...
                        {
                            bool p = (first2 >= last2)
                                     || ((first1 < last1) && !comp(*first2, *first1));
                    ...
                    template <typename Size,
                              ...
                              typename Iterator2,
                              typename Compare>
                    __device__ Size merge_path(Size      pos,
                                               Iterator1 first1,
                                               Size      n1,
                                               Iterator2 first2,
                                               Size      n2,
