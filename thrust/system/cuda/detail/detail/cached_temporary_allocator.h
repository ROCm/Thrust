        ...
        namespace cuda
        {
            namespace detail
            {
                namespace detail
                {
                    ...
                    {
                    private:
                        typedef thrust::detail::temporary_allocator<char, DerivedPolicy>
                                                                                      base_allocator_type;
                        ...
                        void free_all()
                        {
                                ...
                                ++i)
                            {
                                ...
                                traits::deallocate(
                                    m_base_allocator,
                                    allocator_pointer(reinterpret_cast<char*>(i->second)),
                                    i->first);
                            }
                                ...
                                ++i)
                            {
                                ...
                                traits::deallocate(
                                    m_base_allocator,
                                    allocator_pointer(reinterpret_cast<char*>(i->first)),
                                    i->second);
                            }
                        }
                        ...
                        void* allocate(std::ptrdiff_t num_bytes)
                        {
                            ...
                            else
                            {
                                ...
                                result = thrust::raw_pointer_cast(
                                    traits::allocate(m_base_allocator, num_bytes));
                            }
                    ...
                    template <typename T,
                              ...
                              template <typename>
                              class BasePolicy>
                    thrust::pair<T*, std::ptrdiff_t> get_temporary_buffer(
                        cached_temporary_allocator<DerivedPolicy, BasePolicy>& alloc,
                        std::ptrdiff_t                                         n)
                    {
                    ...
                    void return_temporary_buffer(
                        cached_temporary_allocator<DerivedPolicy, BasePolicy>& alloc, Pointer p)
                    {
