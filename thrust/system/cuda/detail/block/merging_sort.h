            ...
            namespace detail
            {
                namespace block
                {
                    ...
                    __device__ void conditional_swap(RandomAccessIterator1 keys_first,
                                                     ...
                                                     Compare               comp)
                    {
                        typedef typename thrust::iterator_traits<RandomAccessIterator1>::value_type
                            KeyType;
                        typedef typename thrust::iterator_traits<RandomAccessIterator2>::value_type
                            ValueType;
                                          ...
                                          StrictWeakOrdering    cmp)
                    {
                        ...
                        while(h < n)
                        {
                            ...
                            typedef
                                typename thrust::iterator_traits<RandomAccessIterator1>::value_type
                                    KeyType;
                            typedef
                                typename thrust::iterator_traits<RandomAccessIterator2>::value_type
                                    ValueType;
                            ...
                            if(i < new_end)
                            {
                                ...
                                if(begin == new_begin) // in the left side of merging pair
                                {
                                    RandomAccessIterator1 result
                                        = thrust::system::detail::generic::scalar::lower_bound_n(
                                            keys_first + end, new_end - end, key, cmp);
                                    rank += (result - (keys_first + end));
                                }
                                else // in the right side of merging pair
                                {
                                    RandomAccessIterator1 result
                                        = thrust::system::detail::generic::scalar::upper_bound_n(
                                            keys_first + new_begin, begin - new_begin, key, cmp);
