        ...
        namespace cuda
        {
            namespace detail
            {
                ...
                namespace
                {
                    ...
                    inline __host__ __device__ typename thrust::iterator_value<Pointer>::type
                                    get_value_msvc2005_war(execution_policy<DerivedPolicy>& exec, Pointer ptr)
                    {
                        ...
                        {
                            __host__ inline static result_type
                                host_path(execution_policy<DerivedPolicy>& exec, Pointer ptr)
                            {
                                ...
                                cross_system<thrust::host_system_tag, DerivedPolicy> systems(
                                    host_tag, exec);
                            ...
                            __device__ inline static result_type
                                device_path(execution_policy<DerivedPolicy>&, Pointer ptr)
                            {
