 ...
 */
        __host__ __device__ inline int current_device();

        /*! Returns a copy of the device_properties_t structure
 *  that is associated with a given device.
 */
        __host__ __device__ inline device_properties_t device_properties(int device_id);

        /*! Returns a copy of the device_properties_t structure
 *  that is associated with the current device.
 */
        __host__ __device__ inline device_properties_t device_properties();

        /*! Returns a copy of the function_attributes_t structure
 *  that is associated with a given __global__ function
 */
        template <typename KernelFunction>
        __host__ __device__ inline function_attributes_t function_attributes(KernelFunction kernel);
 ...
 */
        __host__ __device__ inline size_t compute_capability(const device_properties_t& properties);

        __host__ __device__ inline size_t compute_capability();
