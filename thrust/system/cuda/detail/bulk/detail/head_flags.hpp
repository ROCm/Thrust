...
namespace bulk
{
    namespace detail
    {
        ...
        public:
            ...
            __bulk_exec_check_disable__ __host__ __device__ head_flags_with_init(
            ...
            __host__ __device__ head_flags_with_init(RandomAccessIterator first,
        ...
        public:
            ...
            __host__ __device__
                ...
                head_flags_(RandomAccessIterator first,
                            RandomAccessIterator last,
                            BinaryPredicate      binary_pred)
                : m_begin(thrust::make_transform_iterator(
                    thrust::make_zip_iterator(thrust::make_tuple(
        ...
        __host__ __device__
            ...
            head_flags_<RandomAccessIterator, BinaryPredicate>
            make_head_flags(RandomAccessIterator first,
                            RandomAccessIterator last,
                            BinaryPredicate      binary_pred)
        {
