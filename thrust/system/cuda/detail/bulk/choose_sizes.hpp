...
namespace bulk
{
    ...
    __host__ __device__ thrust::pair<typename parallel_group<concurrent_group<>>::size_type,
    ...
    __host__ __device__ thrust::pair<typename parallel_group<concurrent_group<>>::size_type,
                                     typename concurrent_group<>::size_type>
                        choose_sizes(
                            parallel_group<concurrent_group<>> g, Function f, Arg1 arg1, Arg2 arg2, Arg3 arg3);

    template <typename Function, typename Arg1, typename Arg2, typename Arg3, typename Arg4>
    __host__ __device__ thrust::pair<typename parallel_group<concurrent_group<>>::size_type,
                                     typename concurrent_group<>::size_type>
                        choose_sizes(parallel_group<concurrent_group<>> g,
                                     Function                           f,
                                     Arg1                               arg1,
                                     Arg2                               arg2,
                                     Arg3                               arg3,
