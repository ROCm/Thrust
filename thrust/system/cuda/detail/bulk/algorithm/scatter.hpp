...
namespace bulk
{
    ...
    __forceinline__ __device__ void scatter_if(const bounded<bound, agent<grainsize>>& exec,
    ...
    template <std::size_t groupsize,
              ...
              typename RandomAccessIterator3,
              typename RandomAccessIterator4>
    __device__ void scatter_if(bulk::concurrent_group<bulk::agent<grainsize>, groupsize>& g,
                               RandomAccessIterator1                                      first,
                               RandomAccessIterator1                                      last,
                               RandomAccessIterator2                                      map,
                               RandomAccessIterator3                                      stencil,
