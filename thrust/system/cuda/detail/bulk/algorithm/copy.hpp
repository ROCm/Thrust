...
namespace bulk
{
    ...
    __forceinline__ __device__ RandomAccessIterator2
                               copy_n(const bounded<bound, agent<grainsize>>& b,
    ...
    namespace detail
    {
        ...
        template <typename ConcurrentGroup,
                  ...
                  typename Size,
                  typename RandomAccessIterator2>
        __forceinline__ __device__ RandomAccessIterator2 simple_copy_n(ConcurrentGroup&      g,
                                                                       RandomAccessIterator1 first,
                                                                       Size                  n,
                                                                       RandomAccessIterator2 result)
        {
        ...
        __forceinline__ __device__
            typename thrust::detail::enable_if<(size * grainsize > 0), RandomAccessIterator2>::type
            simple_copy_n(bulk::concurrent_group<agent<grainsize>, size>& g,
                          RandomAccessIterator1                           first,
                          Size                                            n,
                          RandomAccessIterator2                           result)
        {
            typedef bulk::concurrent_group<agent<grainsize>, size> group_type;
            ...
            else
            {
                ...
                for(RandomAccessIterator1 last = first + n; first < last;
        ...
        template <std::size_t size,
                  ...
                  typename RandomAccessIterator2>
        __forceinline__ __device__ RandomAccessIterator2
                                   copy_n(concurrent_group<agent<grainsize>, size>& g,
                                          RandomAccessIterator1                     first,
                                          Size                                      n,
                                          RandomAccessIterator2                     result)
        {
    ...
    template <std::size_t groupsize,
              ...
              typename RandomAccessIterator2>
    __forceinline__ __device__ RandomAccessIterator2
                               copy_n(bulk::concurrent_group<Executor, groupsize>& g,
                                      RandomAccessIterator1                        first,
                                      Size                                         n,
                                      RandomAccessIterator2                        result)
    {
    ...
    __device__ typename thrust::detail::enable_if<(bound <= groupsize * grainsize),
        ...
        copy_n(bulk::bounded<bound, concurrent_group<agent<grainsize>, groupsize>>& g,
               RandomAccessIterator1                                                first,
               Size                                                                 n,
               RandomAccessIterator2                                                result)
    {
