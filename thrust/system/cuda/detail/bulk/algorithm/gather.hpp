...
namespace bulk
{
    ...
    __forceinline__ __device__ RandomAccessIterator3 gather(const bounded<bound, agent<grainsize>>&,
    ...
    template <typename ExecutionGroup,
              ...
              typename RandomAccessIterator2,
              typename RandomAccessIterator3>
    __forceinline__ __device__ RandomAccessIterator3 gather(ExecutionGroup&       g,
                                                            RandomAccessIterator1 map_first,
                                                            RandomAccessIterator1 map_last,
                                                            RandomAccessIterator2 input_first,
                                                            RandomAccessIterator3 result)
