...
namespace bulk
{
    ...
    __host__ __device__ future<void> async(ExecutionGroup g, Function f);

    template <typename ExecutionGroup, typename Function, typename Arg1>
    __host__ __device__ future<void> async(ExecutionGroup g, Function f, Arg1 arg1);

    template <typename ExecutionGroup, typename Function, typename Arg1, typename Arg2>
    __host__ __device__ future<void> async(ExecutionGroup g, Function f, Arg1 arg1, Arg2 arg2);
    ...
    template <typename ExecutionGroup,
              ...
              typename Arg2,
              typename Arg3>
    __host__ __device__ future<void>
    ...
    template <typename ExecutionGroup,
              ...
              typename Arg5,
              typename Arg6>
    __host__ __device__ future<void> async(ExecutionGroup g,
                                           Function       f,
                                           Arg1           arg1,
                                           Arg2           arg2,
                                           Arg3           arg3,
