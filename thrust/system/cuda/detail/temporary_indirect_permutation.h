    ...
    namespace system
    {
        namespace cuda
        {
            namespace detail
            {
                ...
                public:
                    __host__ __device__ temporary_indirect_permutation(
                    ...
                    __host__ __device__ ~temporary_indirect_permutation()
                    {
                        ...
                        typedef
                            typename thrust::iterator_value<RandomAccessIterator>::type value_type;
                        thrust::detail::temporary_array<value_type, DerivedPolicy>      temp(
                            m_exec, m_src_first, m_src_last);
                        thrust::gather(m_exec,
                                       m_permutation.begin(),
                                       m_permutation.end(),
                                       temp.begin(),
                                       m_src_first);
                ...
                {
                    __host__ __device__ iterator_range_with_execution_policy(
                        thrust::execution_policy<DerivedPolicy>& exec,
                        RandomAccessIterator                     first,
                        RandomAccessIterator                     last)
                        : m_exec(derived_cast(exec))
                    ...
                    __host__ __device__ DerivedPolicy& exec()
                    {
                        return m_exec;
                    }
                ...
                struct conditional_temporary_indirect_permutation
                    : thrust::detail::eval_if<
                          ...
                          thrust::detail::identity_<
                              iterator_range_with_execution_policy<DerivedPolicy,
                                                                   RandomAccessIterator>>>::type
                {
                    ...
                    __host__ __device__ conditional_temporary_indirect_permutation(
                        thrust::execution_policy<DerivedPolicy>& exec,
                        RandomAccessIterator                     first,
                        RandomAccessIterator                     last)
                ...
                {
                private:
                    typedef temporary_indirect_permutation<DerivedPolicy, RandomAccessIterator>
                        super_t;

                public:
                    __host__ __device__
                             temporary_indirect_ordering(thrust::execution_policy<DerivedPolicy>& exec,
                                                         RandomAccessIterator                     first,
                                                         RandomAccessIterator                     last,
                                                         Compare                                  comp)
                        : super_t(exec, first, last)
                    ...
                    struct compare
                    {
                        ...
                        __host__ __device__ compare(RandomAccessIterator first, Compare comp)
                            : first(first)
                            , comp(comp)
                        {
                        }
                        ...
                        __host__ __device__ bool operator()(Integral a, Integral b)
                        {
                            return comp(first[a], first[b]);
                        }
                    };

                    __host__ __device__ compare comp() const
                    {
                        return m_comp;
                    }
                ...
                {
                    typedef iterator_range_with_execution_policy<DerivedPolicy,
                                                                 RandomAccessIterator>
                        super_t;

                    __host__ __device__ iterator_range_with_execution_policy_and_compare(
                        thrust::execution_policy<DerivedPolicy>& exec,
                        RandomAccessIterator                     first,
                        RandomAccessIterator                     last,
                        Compare                                  comp)
                    ...
                    __host__ __device__ compare comp()
                    {
                        return m_comp;
                    }
                ...
                struct conditional_temporary_indirect_ordering
                    : thrust::detail::eval_if<
                          Condition::value,
                          thrust::detail::identity_<
                              temporary_indirect_ordering<DerivedPolicy,
                                                          RandomAccessIterator,
                                                          Compare>>,
                          thrust::detail::identity_<
                                                                               ...
                                                                               Compare>>>::type
                {
                    typedef typename thrust::detail::eval_if<
                        Condition::value,
                        thrust::detail::identity_<temporary_indirect_ordering<DerivedPolicy,
                                                                              RandomAccessIterator,
                                                                              Compare>>,
                        thrust::detail::identity_<
                            iterator_range_with_execution_policy_and_compare<DerivedPolicy,
                    ...
                    __host__ __device__ conditional_temporary_indirect_ordering(
                        thrust::execution_policy<DerivedPolicy>& exec,
                        RandomAccessIterator                     first,
                        RandomAccessIterator                     last,
                        Compare                                  comp)
