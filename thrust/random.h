 ...
 *  \brief \p thrust::random is the namespace which contains random number
 * engine class templates, random number engine adaptor class templates, engines
 * with predefined parameters, and random number distribution class templates.
 * They are provided in a separate namespace for import convenience but are also
 * aliased in the top-level \p thrust namespace for easy access.
 */
    namespace random
    {

        /*! \addtogroup predefined_random Random Number Engines with Predefined
 * Parameters \ingroup random
 *  \{
 */
 ...
 * consecutive invocation of a default-constructed object of type \p ranlux24
 ...
 * consecutive invocation of a default-constructed object of type \p ranlux48
 ...
 *
 *  \note The 10000th consecutive invocation of a default-constructed object of
 * type \p taus88 shall produce the value \c 3535848941 .
 */
        typedef xor_combine_engine<
            linear_feedback_shift_engine<thrust::detail::uint32_t, 32u, 31u, 13u, 12u>,
            0,
            xor_combine_engine<
                linear_feedback_shift_engine<thrust::detail::uint32_t, 32u, 29u, 2u, 4u>,
                0,
 ...
 *  \note \p default_random_engine is currently an alias for \p minstd_rand, and
