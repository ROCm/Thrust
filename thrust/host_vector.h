...
/*! \file host_vector.h
 *  \brief A dynamically-sizable array of elements which reside in the "host"
 * memory space
 */
 ...
 */
   ...
   */
        __host__ explicit host_vector(size_type n)
            : Parent(n)
        {
        }
   ...
   */
        __host__ explicit host_vector(size_type n, const value_type& value)
            : Parent(n, value)
        {
        }
   ...
   */
        ...
        /*! Copy constructor copies from an exemplar \p host_vector with different
   * type. \param v The \p host_vector to copy.
   */
        ...
        /*! Assign operator copies from an exemplar \p host_vector with different
   * type. \param v The \p host_vector to copy.
   */
        template <typename OtherT, typename OtherAlloc>
   ...
   */
        ...
        /*! Copy constructor copies from an exemplar \p device_vector with possibly
   * different type. \param v The \p device_vector to copy.
   */
        template <typename OtherT, typename OtherAlloc>
   ...
   */
        template <typename OtherT, typename OtherAlloc>
        __host__ host_vector& operator=(const device_vector<OtherT, OtherAlloc>& v)
        {
            Parent::operator=(v);
            return *this;
        }
