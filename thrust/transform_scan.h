 ...
 * \c InputIterator's \c value_type is convertible to \c unary_op's input type.
 ...
 * accepts inputs of \c InputIterator's \c value_type.  \c UnaryFunction's
 * result_type is convertable to \c OutputIterator's \c value_type. \tparam
 ...
 * transform_inclusive_scan using the \p thrust::host execution policy for
 * parallelization:
 *
 *  \code
 ...
 *
 *  thrust::transform_inclusive_scan(thrust::host, data, data + 6, data,
 * unary_op, binary_op); // in-place scan
 *
 ...
 * href="http://www.sgi.com/tech/stl/UnaryFunction.html">Unary Function</a> and
 * accepts inputs of \c InputIterator's \c value_type.  \c UnaryFunction's
 * result_type is convertable to \c OutputIterator's \c value_type. \tparam T is
 * convertible to \c OutputIterator's \c value_type. \tparam AssociativeOperator
 * is a model of <a
 * href="http://www.sgi.com/tech/stl/BinaryFunction.html">Binary Function</a>
 *                              and \c AssociativeOperator's \c result_type is
 *                              convertible to \c OutputIterator's \c
 ...
 *
 *  The following code snippet demonstrates how to use \p
 * transform_exclusive_scan using the \p thrust::host execution policy for
 * parallelization:
 *
 *  \code
 *  #include <thrust/transform_scan.h>
 ...
 *  thrust::plus<int> binary_op;
 *
 *  thrust::transform_exclusive_scan(thrust::host, data, data + 6, data,
 * unary_op, 4, binary_op); // in-place scan
 *
 ...
 *  thrust::plus<int> binary_op;
 *
 *  thrust::transform_exclusive_scan(data, data + 6, data, unary_op, 4,
