        ...
        namespace detail
        {
            ...
            struct lshift_w
            {
                ...
                static const UIntType value
                    = detail::lshift_w<UIntType, w, lhs, rhs, shift_will_overflow>::value;
            };
            ...
            struct xor_combine_engine_max_aux_case4
            {
                ...
                static const result_type M = xor_combine_engine_max_aux<
                    result_type,
                ...
                static const result_type value
                    = math::plus<result_type, k_plus_1_times_two_to_the_p, M>::value;
            };
            ...
            struct xor_combine_engine_max_aux_case2
            {
                ...
                static const result_type value
                    = math::minus<result_type, k_plus_1_times_two_to_the_p, 1>::value;
            };
            ...
            struct xor_combine_engine_max
            {
                ...
                static const result_type M
                    = xor_combine_engine_max_aux<result_type, m1, m2, s>::value;
