...
namespace thrust
{
    ...
    namespace random
    {
        ...
        /*! \addtogroup random_number_distributions Random Number Distributions Class
 * Templates \ingroup random
 *  \{
 */

        /*! \class uniform_int_distribution
 *  \brief A \p uniform_int_distribution random number distribution produces
 * signed or unsigned integer uniform random numbers from a given range.
 *
 *  \tparam IntType The type of integer to produce.
 *
 *  The following code snippet demonstrates examples of using a \p
 * uniform_int_distribution with a random number engine to produce random
 ...
 */
        ...
        public:
            ...
            /*! \typedef result_type
   *  \brief The type of the integer produced by this \p
   ...
   * uniform_int_distribution's parameters.
   */
            typedef thrust::pair<IntType, IntType> param_type;

            // constructors and reset functions

            /*! This constructor creates a new \p uniform_int_distribution from two values
   * defining the range of the distribution.
   *
   *  \param a The smallest integer to potentially produce. Defaults to \c 0.
   *  \param b The largest integer to potentially produce. Defaults to the
   * largest representable integer in the platform.
   */
            ...
            /*! This constructor creates a new \p uniform_int_distribution from a \p
   ...
   * uniform_int_distribution's range using a \p UniformRandomNumberGenerator as
   ...
   * \p uniform_int_distribution from the given \p param_type object, and
   ...
   * of the \p uniform_int_distribution to draw from.
   */
            template <typename UniformRandomNumberGenerator>
            __host__ __device__ result_type operator()(UniformRandomNumberGenerator& urng,
   ...
   * uniform_int_distribution was constructed.
   *
   ...
   * with which this \p uniform_int_distribution was constructed.
   *
   *  \return A \p param_type object enapsulating the range of this \p
   * uniform_int_distribution.
   */
            __host__ __device__ param_type param(void) const;

            /*! This method changes the parameters of this \p uniform_int_distribution
   * using the values encapsulated in a given \p param_type object.
   *
   *  \param parm A \p param_type object encapsulating the new range of this \p
   * uniform_int_distribution.
   */
            __host__ __device__ void param(const param_type& parm);

            /*! This method returns the smallest integer this \p uniform_int_distribution
   ...
   */
            ...
            /*! This method returns the largest integer this \p uniform_int_distribution
   * can potentially produce.
   *
   *  \return The upper bound of this \p uniform_int_distribution's range.
   */
 ...
 */
        ...
        /*! This function streams a uniform_int_distribution in from a
 * std::basic_istream. \param is The \p basic_istream to stream from. \param d
 * The \p uniform_int_distribution to stream in. \return \p is
 */
        template <typename IntType, typename CharT, typename Traits>
