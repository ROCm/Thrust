 ...
 *    thrust::transform_output_iterator<square_root, FloatIterator>
 ...
 */
   ...
   *
   * \param out An \c OutputIterator pointing to the output range whereto the
   * result of \p transform_output_iterator's \c UnaryFunction will be written.
