    ...
    namespace detail
    {
        ...
        namespace join_iterator_detail
        {
            ...
            struct join_iterator_base
            {
                ...
                typedef thrust::iterator_adaptor<join_iterator<RandomAccessIterator1,
        ...
        template <typename RandomAccessIterator1,
                  typename RandomAccessIterator2,
                  typename Difference =
                      typename thrust::iterator_difference<RandomAccessIterator1>::type,
                  typename Reference = typename thrust::iterator_value<RandomAccessIterator1>::type>
        class join_iterator : public join_iterator_detail::join_iterator_base<RandomAccessIterator1,
                                                                              RandomAccessIterator2,
                                                                              Difference,
                                                                              Reference>::type
        {
        private:
            typedef typename join_iterator_detail::join_iterator_base<RandomAccessIterator1,
                                                                      RandomAccessIterator2,
                                                                      Difference,
                                                                      Reference>::type super_t;
            typedef typename super_t::difference_type                                  size_type;

        public:
            inline __host__ __device__ join_iterator(RandomAccessIterator1 first1,
                                                     size_type             n,
            ...
            inline __host__ __device__ join_iterator(const join_iterator& other)
                : super_t(other)
                , m_n1(other.m_n1)
        ...
        private:
            ...
            __host__ __device__ typename super_t::reference dereference() const
            {
                ...
                return (i < m_n1) ? m_iter1[i]
                                  : static_cast<typename super_t::reference>(m_iter2[i]);
            } // end dereference()
        ...
        __host__ __device__ join_iterator<RandomAccessIterator1, RandomAccessIterator2, Size>
                            make_join_iterator(RandomAccessIterator1 first1, Size n1, RandomAccessIterator2 first2)
        {
            return join_iterator<RandomAccessIterator1, RandomAccessIterator2, Size>(
                first1, n1, first2);
