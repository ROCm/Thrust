...
namespace thrust
{
    namespace detail
    {
        ...
        struct is_retaggable : integral_constant<bool,
                                                 (is_convertible<FromTag, ToTag>::value
                                                  || is_convertible<ToTag, FromTag>::value)>
        {
        };
    ...
    __host__ __device__ thrust::detail::tagged_iterator<Iterator, Tag>
    ...
    __host__ __device__ thrust::pointer<T, Tag> reinterpret_tag(T* ptr)
    {
    ...
    __host__ __device__ thrust::pointer<T, Tag>
    ...
    __host__ __device__ thrust::detail::tagged_iterator<BaseIterator, Tag>
    ...
    template <typename Tag, typename Iterator>
    __host__ __device__ typename thrust::detail::enable_if_retaggable<
    ...
    template <typename Tag, typename T>
    __host__ __device__
        typename thrust::detail::enable_if_retaggable<typename thrust::iterator_system<T*>::type,
                                                      Tag,
                                                      thrust::pointer<T, Tag>>::type
        retag(T* ptr)
    {
    ...
    __host__ __device__
        typename thrust::detail::enable_if_retaggable<OtherTag, Tag, thrust::pointer<T, Tag>>::type
    ...
    __host__ __device__ typename thrust::detail::enable_if_retaggable<
        OtherTag,
        Tag,
        thrust::detail::tagged_iterator<BaseIterator, Tag>>::type
