...
namespace thrust
{
    ...
    namespace detail
    {
        ...
        // adapted from
        // http://www.boost.org/doc/libs/1_37_0/libs/iterator/doc/iterator_facade.html#iterator-category
        //
        ...
        // may not be a complete type at this point, and implementations of
        // is_convertible typically require that both types be complete. Instead, it
        // simply assumes that if is_convertible<Traversal, single_pass_traversal_tag>,
        ...
        struct iterator_facade_default_category_std
            : thrust::detail::eval_if<
                  ...
                  thrust::detail::eval_if<
                      thrust::detail::is_convertible<Traversal,
                                                     thrust::random_access_traversal_tag>::value,
                      thrust::detail::identity_<std::random_access_iterator_tag>,
                      thrust::detail::eval_if<
                          thrust::detail::
                              is_convertible<Traversal, thrust::bidirectional_traversal_tag>::value,
                  ...
                  thrust::detail::eval_if< // XXX note we differ from Boost here
                      thrust::detail::is_convertible<Traversal,
                                                     thrust::single_pass_traversal_tag>::value,
            ...
            : thrust::detail::eval_if<
                  ...
                  thrust::detail::eval_if<
                      thrust::detail::is_convertible<Traversal, thrust::single_pass_traversal_tag>::
                          value, // XXX note we differ from Boost here
        ...
        struct iterator_facade_default_category_any
        {
            typedef thrust::detail::iterator_category_with_system_and_traversal<
                typename iterator_facade_default_category_std<Traversal, ValueParam, Reference>::
                    type,
            ...
            : thrust::detail::eval_if<
                  ...
                  thrust::detail::eval_if<
                      ...
                      thrust::detail::eval_if<
                          ...
                          // if we don't recognize the system, get a standard iterator
                          // category and combine it with System & Traversal
                          thrust::detail::identity_<
                              thrust::detail::iterator_category_with_system_and_traversal<
                                  typename iterator_facade_default_category_std<Traversal,
                                                                                ValueParam,
                                                                                Reference>::type,
                                  System,
                                  Traversal>>>>>
        ...
        struct iterator_facade_category_impl
        {
            ...
            typedef typename thrust::detail::eval_if<
                thrust::detail::and_<
                    ...
                    thrust::detail::is_same<System,
                                            typename thrust::detail::iterator_category_to_system<
                                                category>::type>>::value,
        ...
        struct iterator_facade_category
        {
            typedef typename thrust::detail::eval_if<
                ...
                thrust::detail::identity_<CategoryOrTraversal>, // categories are fine
                // as-is
                iterator_facade_category_impl<CategoryOrSystem,
                                              CategoryOrTraversal,
                                              ValueParam,
                                              Reference>>::type type;
