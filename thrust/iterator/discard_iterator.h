 ...
 *  \brief An iterator which "discards" (ignores) values assigned to it upon
 * dereference
 */
 ...
 */
    ...
    /*! \p discard_iterator is an iterator which represents a special kind of
 * pointer that ignores values written to it upon dereference. This iterator is
 * useful for ignoring the output of certain algorithms without wasting memory
 * capacity or bandwidth. \p discard_iterator may also be used to count the size
 * of an algorithm's output which may not be known a priori.
 *
 *  The following code snippet demonstrates how to use \p discard_iterator to
 * ignore ignore one of the output ranges of reduce_by_key
 *
 *  \code
 ...
 */
   ...
   */
        ...
        /*! This constructor receives an optional index specifying the position of
   * this \p discard_iterator in a range.
   *
   ...
   */
    ...
    /*! \p make_discard_iterator creates a \p discard_iterator from an optional
 * index parameter.
 *
