 ...
 * href="http://www.sgi.com/tech/stl/ForwardIterator">Forward Iterator</a>.
 *  \tparam LessThanComparable is a model of <a
 ...
 *  to search for values in a ordered range using the \p thrust::device
 ...
 *  input[4] = 8;
 *
 *  thrust::lower_bound(thrust::device, input.begin(), input.end(), 0); //
 * returns input.begin() thrust::lower_bound(thrust::device, input.begin(),
 * input.end(), 1); // returns input.begin() + 1
 *  thrust::lower_bound(thrust::device, input.begin(), input.end(), 2); //
 * returns input.begin() + 1 thrust::lower_bound(thrust::device, input.begin(),
 * input.end(), 3); // returns input.begin() + 2
 *  thrust::lower_bound(thrust::device, input.begin(), input.end(), 8); //
 * returns input.begin() + 4 thrust::lower_bound(thrust::device, input.begin(),
 * input.end(), 9); // returns input.end() \endcode
 *
 ...
 *  thrust::lower_bound(input.begin(), input.end(), 1); // returns input.begin()
 * + 1 thrust::lower_bound(input.begin(), input.end(), 2); // returns
 * input.begin() + 1 thrust::lower_bound(input.begin(), input.end(), 3); //
 * returns input.begin() + 2 thrust::lower_bound(input.begin(), input.end(), 8);
 * // returns input.begin() + 4 thrust::lower_bound(input.begin(), input.end(),
 * 9); // returns input.end() \endcode
 *
 *  \see http://www.sgi.com/tech/stl/lower_bound.html
 *  \see \p upper_bound
 *  \see \p equal_range
 ...
 *  \return The furthermost iterator \c i, such that <tt>comp(*i, value)</tt> is
 * \c true.
 *
 *  \tparam DerivedPolicy The name of the derived execution policy.
 *  \tparam ForwardIterator is a model of <a
 ...
 *  \tparam StrictWeakOrdering is a model of <a
 ...
 * returns input.begin() thrust::lower_bound(input.begin(), input.end(), 1,
 * thrust::less<int>()); // returns input.begin() + 1
 *  thrust::lower_bound(input.begin(), input.end(), 2, thrust::less<int>()); //
 * returns input.begin() + 1 thrust::lower_bound(input.begin(), input.end(), 3,
 * thrust::less<int>()); // returns input.begin() + 2
 *  thrust::lower_bound(input.begin(), input.end(), 8, thrust::less<int>()); //
 * returns input.begin() + 4 thrust::lower_bound(input.begin(), input.end(), 9,
 * thrust::less<int>()); // returns input.end() \endcode
 *
 *  \see http://www.sgi.com/tech/stl/lower_bound.html
 *  \see \p upper_bound
 *  \see \p equal_range
 ...
 *  \param last The end of the ordered sequence.
 *  \param value The value to be searched.
 *  \return The furthermost iterator \c i, such that <tt>value < *i</tt> is \c
 * false.
 *
 *  \tparam DerivedPolicy The name of the derived execution policy.
 *  \tparam ForwardIterator is a model of <a
 ...
 *  input[4] = 8;
 *
 *  thrust::upper_bound(thrust::device, input.begin(), input.end(), 0); //
 * returns input.begin() + 1 thrust::upper_bound(thrust::device, input.begin(),
 * input.end(), 1); // returns input.begin() + 1
 *  thrust::upper_bound(thrust::device, input.begin(), input.end(), 2); //
 * returns input.begin() + 2 thrust::upper_bound(thrust::device, input.begin(),
 * input.end(), 3); // returns input.begin() + 2
 *  thrust::upper_bound(thrust::device, input.begin(), input.end(), 8); //
 * returns input.end() thrust::upper_bound(thrust::device, input.begin(),
 * input.end(), 9); // returns input.end() \endcode
 *
 ...
 *  input[4] = 8;
 *
 *  thrust::upper_bound(input.begin(), input.end(), 0); // returns input.begin()
 * + 1 thrust::upper_bound(input.begin(), input.end(), 1); // returns
 * input.begin() + 1 thrust::upper_bound(input.begin(), input.end(), 2); //
 * returns input.begin() + 2 thrust::upper_bound(input.begin(), input.end(), 3);
 * // returns input.begin() + 2 thrust::upper_bound(input.begin(), input.end(),
 * 8); // returns input.end() thrust::upper_bound(input.begin(), input.end(),
 * 9); // returns input.end() \endcode
 *
 *  \see http://www.sgi.com/tech/stl/upper_bound.html
 *  \see \p lower_bound
 ...
 *  \param value The value to be searched.
 *  \param comp The comparison operator.
 *  \return The furthermost iterator \c i, such that <tt>comp(value, *i)</tt> is
 * \c false.
 *
 *  \tparam DerivedPolicy The name of the derived execution policy.
 *  \tparam ForwardIterator is a model of <a
 ...
 *  thrust::upper_bound(thrust::device, input.begin(), input.end(), 0,
 * thrust::less<int>()); // returns input.begin() + 1
 *  thrust::upper_bound(thrust::device, input.begin(), input.end(), 1,
 * thrust::less<int>()); // returns input.begin() + 1
 *  thrust::upper_bound(thrust::device, input.begin(), input.end(), 2,
 * thrust::less<int>()); // returns input.begin() + 2
 *  thrust::upper_bound(thrust::device, input.begin(), input.end(), 3,
 * thrust::less<int>()); // returns input.begin() + 2
 *  thrust::upper_bound(thrust::device, input.begin(), input.end(), 8,
 * thrust::less<int>()); // returns input.end()
 *  thrust::upper_bound(thrust::device, input.begin(), input.end(), 9,
 * thrust::less<int>()); // returns input.end() \endcode
 *
 *  \see http://www.sgi.com/tech/stl/upper_bound.html
 *  \see \p lower_bound
 ...
 * returns input.begin() + 1 thrust::upper_bound(input.begin(), input.end(), 1,
 * thrust::less<int>()); // returns input.begin() + 1
 *  thrust::upper_bound(input.begin(), input.end(), 2, thrust::less<int>()); //
 * returns input.begin() + 2 thrust::upper_bound(input.begin(), input.end(), 3,
 * thrust::less<int>()); // returns input.begin() + 2
 *  thrust::upper_bound(input.begin(), input.end(), 8, thrust::less<int>()); //
 * returns input.end() thrust::upper_bound(input.begin(), input.end(), 9,
 * thrust::less<int>()); // returns input.end() \endcode
 *
 *  \see http://www.sgi.com/tech/stl/upper_bound.html
 *  \see \p lower_bound
 ...
 *  \param last The end of the ordered sequence.
 *  \param value The value to be searched.
 *  \return \c true if an equivalent element exists in <tt>[first, last)</tt>,
 * otherwise \c false.
 *
 *  \tparam DerivedPolicy The name of the derived execution policy.
 *  \tparam ForwardIterator is a model of <a
 ...
 *  input[4] = 8;
 *
 *  thrust::binary_search(thrust::device, input.begin(), input.end(), 0); //
 * returns true thrust::binary_search(thrust::device, input.begin(),
 * input.end(), 1); // returns false thrust::binary_search(thrust::device,
 * input.begin(), input.end(), 2); // returns true
 *  thrust::binary_search(thrust::device, input.begin(), input.end(), 3); //
 * returns false thrust::binary_search(thrust::device, input.begin(),
 * input.end(), 8); // returns true thrust::binary_search(thrust::device,
 * input.begin(), input.end(), 9); // returns false \endcode
 *
 ...
 *
 *  thrust::binary_search(thrust::device, input.begin(), input.end(), 0,
 * thrust::less<int>()); // returns true thrust::binary_search(thrust::device,
 * input.begin(), input.end(), 1, thrust::less<int>()); // returns false
 *  thrust::binary_search(thrust::device, input.begin(), input.end(), 2,
 * thrust::less<int>()); // returns true thrust::binary_search(thrust::device,
 * input.begin(), input.end(), 3, thrust::less<int>()); // returns false
 *  thrust::binary_search(thrust::device, input.begin(), input.end(), 8,
 * thrust::less<int>()); // returns true thrust::binary_search(thrust::device,
 * input.begin(), input.end(), 9, thrust::less<int>()); // returns false
 *  \endcode
 *
 *  \see http://www.sgi.com/tech/stl/binary_search.html
 *  \see \p lower_bound
 ...
 * // returns true thrust::binary_search(input.begin(), input.end(), 1,
 * thrust::less<int>()); // returns false thrust::binary_search(input.begin(),
 * input.end(), 2, thrust::less<int>()); // returns true
 *  thrust::binary_search(input.begin(), input.end(), 3, thrust::less<int>());
 * // returns false thrust::binary_search(input.begin(), input.end(), 8,
 * thrust::less<int>()); // returns true thrust::binary_search(input.begin(),
 * input.end(), 9, thrust::less<int>()); // returns false \endcode
 *
 *  \see http://www.sgi.com/tech/stl/binary_search.html
 *  \see \p lower_bound
 *  \see \p upper_bound
 ...
 *  \param last The end of the ordered sequence.
 *  \param value The value to be searched.
 *  \return A \p pair of iterators <tt>[i, j)</tt> that define the range of
 * equivalent elements.
 *
 *  \tparam DerivedPolicy The name of the derived execution policy.
 *  \tparam ForwardIterator is a model of <a
 ...
 *  input[4] = 8;
 *
 *  thrust::equal_range(thrust::device, input.begin(), input.end(), 0); //
 * returns [input.begin(), input.begin() + 1)
 *  thrust::equal_range(thrust::device, input.begin(), input.end(), 1); //
 * returns [input.begin() + 1, input.begin() + 1)
 *  thrust::equal_range(thrust::device, input.begin(), input.end(), 2); //
 * returns [input.begin() + 1, input.begin() + 2)
 *  thrust::equal_range(thrust::device, input.begin(), input.end(), 3); //
 * returns [input.begin() + 2, input.begin() + 2)
 *  thrust::equal_range(thrust::device, input.begin(), input.end(), 8); //
 * returns [input.begin() + 4, input.end) thrust::equal_range(thrust::device,
 * input.begin(), input.end(), 9); // returns [input.end(), input.end) \endcode
 *
 ...
 *  input[4] = 8;
 *
 *  thrust::equal_range(input.begin(), input.end(), 0); // returns
 * [input.begin(), input.begin() + 1) thrust::equal_range(input.begin(),
 * input.end(), 1); // returns [input.begin() + 1, input.begin() + 1)
 *  thrust::equal_range(input.begin(), input.end(), 2); // returns
 * [input.begin() + 1, input.begin() + 2) thrust::equal_range(input.begin(),
 * input.end(), 3); // returns [input.begin() + 2, input.begin() + 2)
 *  thrust::equal_range(input.begin(), input.end(), 8); // returns
 * [input.begin() + 4, input.end) thrust::equal_range(input.begin(),
 * input.end(), 9); // returns [input.end(), input.end) \endcode
 *
 *  \see http://www.sgi.com/tech/stl/equal_range.html
 *  \see \p lower_bound
 *  \see \p upper_bound
 ...
 *
 *  thrust::equal_range(thrust::device, input.begin(), input.end(), 0,
 * thrust::less<int>()); // returns [input.begin(), input.begin() + 1)
 *  thrust::equal_range(thrust::device, input.begin(), input.end(), 1,
 * thrust::less<int>()); // returns [input.begin() + 1, input.begin() + 1)
 *  thrust::equal_range(thrust::device, input.begin(), input.end(), 2,
 * thrust::less<int>()); // returns [input.begin() + 1, input.begin() + 2)
 *  thrust::equal_range(thrust::device, input.begin(), input.end(), 3,
 * thrust::less<int>()); // returns [input.begin() + 2, input.begin() + 2)
 *  thrust::equal_range(thrust::device, input.begin(), input.end(), 8,
 * thrust::less<int>()); // returns [input.begin() + 4, input.end)
 *  thrust::equal_range(thrust::device, input.begin(), input.end(), 9,
 * thrust::less<int>()); // returns [input.end(), input.end) \endcode
 *
 *  \see http://www.sgi.com/tech/stl/equal_range.html
 *  \see \p lower_bound
 *  \see \p upper_bound
 ...
 * returns [input.begin(), input.begin() + 1) thrust::equal_range(input.begin(),
 * input.end(), 1, thrust::less<int>()); // returns [input.begin() + 1,
 * input.begin() + 1) thrust::equal_range(input.begin(), input.end(), 2,
 * thrust::less<int>()); // returns [input.begin() + 1, input.begin() + 2)
 *  thrust::equal_range(input.begin(), input.end(), 3, thrust::less<int>()); //
 * returns [input.begin() + 2, input.begin() + 2)
 *  thrust::equal_range(input.begin(), input.end(), 8, thrust::less<int>()); //
 * returns [input.begin() + 4, input.end) thrust::equal_range(input.begin(),
 * input.end(), 9, thrust::less<int>()); // returns [input.end(), input.end)
 *  \endcode
 *
 *  \see http://www.sgi.com/tech/stl/equal_range.html
 *  \see \p lower_bound
 ...
 */
    template <class ForwardIterator, class T, class StrictWeakOrdering>
    thrust::pair<ForwardIterator, ForwardIterator> equal_range(ForwardIterator    first,
                                                               ForwardIterator    last,
                                                               const T&           value,
                                                               StrictWeakOrdering comp);
 ...
 *
 *  The following code snippet demonstrates how to use \p lower_bound
 *  to search for multiple values in a ordered range using the \p thrust::device
 * execution policy for parallelization:
 *
 *  \code
 *  #include <thrust/binary_search.h>
 ...
 *  \tparam InputIterator is a model of <a
 * href="http://www.sgi.com/tech/stl/InputIterator.html">Input Iterator</a>. and
 * \c InputIterator's \c value_type is comparable to \p ForwardIterator's \c
 * value_type. \tparam OutputIterator is a model of <a
 * href="http://www.sgi.com/tech/stl/OutputIterator.html">Output Iterator</a>.
 *                        and \c ForwardIterator's difference_type is
 * convertible to \c OutputIterator's \c value_type. \tparam StrictWeakOrdering
 * is a model of <a
 * href="http://www.sgi.com/tech/stl/StrictWeakOrdering.html">Strict Weak
 * Ordering</a>.
 *
 ...
 *  \tparam OutputIterator is a model of <a
 * href="http://www.sgi.com/tech/stl/OutputIterator.html">Output Iterator</a>.
 *                        and bool is convertible to \c OutputIterator's \c
 * value_type.
 *
 *  \pre The ranges <tt>[first,last)</tt> and <tt>[result, result + (last -
 * first))</tt> shall not overlap.
 ...
 * href="http://www.sgi.com/tech/stl/OutputIterator.html">Output Iterator</a>.
 *                        and bool is convertible to \c OutputIterator's \c
 * value_type. \tparam StrictWeakOrdering is a model of <a
 * href="http://www.sgi.com/tech/stl/StrictWeakOrdering.html">Strict Weak
 * Ordering</a>.
 *
 *  \pre The ranges <tt>[first,last)</tt> and <tt>[result, result + (last -
