 ...
 * x is an object of type \p OutputType, and \c y is an object of \p
 * InputIterator1's \c value_type, and \c z is an object of \p InputIterator2's
 * \c value_type, then <tt>x + y * z</tt> is defined and is convertible to \p
 * OutputType.
 *
 *  The following code demonstrates how to use \p inner_product to
 *  compute the dot product of two vectors using the \p thrust::host execution
 ...
 *
 *  float result = thrust::inner_product(thrust::host, vec1, vec1 + 3, vec2,
 * 0.0f);
 *
 *  // result == 31.0f
 *  \endcode
 ...
 * <tt>std::inner_product</tt>, this version offers no guarantee on order of
 * execution.
 *
 *  \param first1 The beginning of the first sequence.
 *  \param last1 The end of the first sequence.
 ...
 *  <tt>[first1, last1)</tt> and <tt>[first2, first2 + (last1 - first1))</tt>.
 *
 *  This version of \p inner_product is identical to the first, except that is
 * uses two user-supplied function objects instead of \c operator+ and \c
 * operator*.
 *
 *  Specifically, this version of \p inner_product computes the sum
 ...
 *  \return The inner product of sequences <tt>[first1, last1)</tt> and
 * <tt>[first2, last2)</tt>.
 *
 *  \tparam DerivedPolicy The name of the derived execution policy.
 *  \tparam InputIterator1 is a model of <a
 * href="http://www.sgi.com/tech/stl/InputIterator.html">Input Iterator</a>, and
 * \p InputIterator1's \c value_type is convertible to \p BinaryFunction2's \c
 * first_argument_type. \tparam InputIterator2 is a model of <a
 * href="http://www.sgi.com/tech/stl/InputIterator.html">Input Iterator</a>. and
 * \p InputIterator2's \c value_type is convertible to \p BinaryFunction2's \c
 * second_argument_type. \tparam OutputType is a model of <a
 * href="http://www.sgi.com/tech/stl/Assignable.html">Assignable</a>, and \p
 * OutputType is convertible to \p BinaryFunction1's \c first_argument_type.
 *  \tparam BinaryFunction1 is a model of <a
 * href="http://www.sgi.com/tech/stl/BinaryFunction.html">Binary Function</a>,
 *          and \p BinaryFunction1's \c return_type is convertible to \p
 * OutputType. \tparam BinaryFunction2 is a model of <a
 * href="http://www.sgi.com/tech/stl/BinaryFunction.html">Binary Function</a>,
 *          and \p BinaryFunction2's \c return_type is convertible to \p
 * BinaryFunction1's \c second_argument_type.
 *
 *  \code
 *  #include <thrust/inner_product.h>
 *  #include <thrust/execution_policy.h>
