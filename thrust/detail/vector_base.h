...
namespace thrust
{
   ...
   *  XXX TODO: Make this method redundant with a properly templatized
   * constructor. We would like to copy from a vector whose element type is
   * anything assignable to value_type.
   */
            template <typename OtherT, typename OtherAlloc>
   ...
   *            We would like to copy from a vector whose element type is
   * anything assignable to value_type.
   */
            template <typename OtherT, typename OtherAlloc>
   ...
   *         Otherwise, this method is a request for allocation of additional
   ...
   * unchanged. \throw std::length_error If n exceeds max_size().
   */
   ...
   */
            ...
            /*! This method returns a const_reverse_iterator pointing to one element past
   * the last of this vector_base's reversed sequence. \return rbegin() +
   * size().
   */
   ...
   */
            ...
            /*! This method returns a const_reference referring to the first element of
   * this vector_base. \return The first element of this vector_base.
   */
   ...
   */
            ...
            /*! This method swaps the contents of this vector_base with another
   * vector_base. \param v The vector_base with which to swap.
   */
   ...
   * followed the element at position pos.
   */
            iterator erase(iterator pos);

            /*! This method removes the range of elements [first,last) from this
   * vector_base. \param first The beginning of the range of elements to remove.
   *  \param last The end of the range of elements to remove.
   *  \return An iterator pointing to the new location of the element that
   * followed the last element in the sequence [first,last).
   */
   ...
   *                        and \p InputIterator's \c value_type is a model of
   ...
   */
            ...
            /*! This version of \p assign makes this vector_base a copy of a given input
   * range. \param first The beginning of the range to copy. \param last  The
   * end of the range to copy.
   *
   *  \tparam InputIterator is a model of <a
   * href="http://www.sgi.com/tech/stl/InputIterator">Input Iterator</a>.
   */
            template <typename InputIterator>
   ...
   */
        ...
        private:
            // these methods resolve the ambiguity of the constructor template of form
            // (Iterator, Iterator)
            template <typename IteratorOrIntegralType>
            void
                init_dispatch(IteratorOrIntegralType begin, IteratorOrIntegralType end, false_type);
            ...
            template <typename InputIterator>
            void range_init(InputIterator first,
                            InputIterator last,
                            thrust::incrementable_traversal_tag);

            template <typename ForwardIterator>
            void range_init(ForwardIterator first,
            ...
            // these methods resolve the ambiguity of the insert() template of form
            // (iterator, InputIterator, InputIterator)
            template <typename InputIteratorOrIntegralType>
            void insert_dispatch(iterator                    position,
                                 InputIteratorOrIntegralType first,
                                 InputIteratorOrIntegralType last,
                                 false_type);
            ...
            template <typename InputIteratorOrIntegralType>
            void insert_dispatch(iterator                    position,
                                 InputIteratorOrIntegralType n,
                                 InputIteratorOrIntegralType x,
                                 true_type);
            ...
            // these methods resolve the ambiguity of the assign() template of form
            ...
            void range_assign(RandomAccessIterator first,
 ...
 */
    template <typename T, typename Alloc>
    void swap(detail::vector_base<T, Alloc>& a, detail::vector_base<T, Alloc>& b);
 ...
 */
    ...
    template <typename T1, typename Alloc1, typename T2, typename Alloc2>
    bool operator==(const detail::vector_base<T1, Alloc1>& lhs, const std::vector<T2, Alloc2>& rhs);

    template <typename T1, typename Alloc1, typename T2, typename Alloc2>
    bool operator==(const std::vector<T1, Alloc1>& lhs, const detail::vector_base<T2, Alloc2>& rhs);
