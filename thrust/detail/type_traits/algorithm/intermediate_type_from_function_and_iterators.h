...
namespace thrust
{
    ...
    namespace detail
    {
        ...
        // this trait reports what type should be used as a temporary in certain
        // algorithms which aggregate intermediate results from a function before
        // writing to an output iterator
