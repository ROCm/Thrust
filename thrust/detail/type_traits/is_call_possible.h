...
#define __THRUST_DEFINE_IS_CALL_POSSIBLE(trait_name, member_function_name)                      \
    ...
    private:                                                                                    \
        ...
        {                                                                                       \
            ...
            no member_function_name(...) const;                                                 \
                                                                                                ...
                                                                                                \
        typedef                                                                                 \
            typename thrust::detail::is_call_possible_detail::clone_constness<T, derived>::type \
                derived_type;                                                                   \
                                                                                                \
        ...
        {                                                                                       \
            ...
            static const bool value                                                             \
                = sizeof(return_value_check<T, Result>::deduce(                                 \
                      (test_me.member_function_name(arg),                                       \
        ...
        {                                                                                       \
            ...
            static const bool value                                                             \
                = sizeof(return_value_check<T, Result>::deduce(                                 \
                      (test_me.member_function_name(arg1, arg2),                                \
                       thrust::detail::is_call_possible_detail::void_exp_result<T>())))         \
                  == sizeof(yes);                                                               \
        };                                                                                      \
                                                                                                \
        ...
        {                                                                                       \
            ...
            static const bool value                                                             \
                = sizeof(return_value_check<T, Result>::deduce(                                 \
                      (test_me.member_function_name(arg1, arg2, arg3),                          \
                       thrust::detail::is_call_possible_detail::void_exp_result<T>())))         \
                  == sizeof(yes);                                                               \
        };                                                                                      \
                                                                                                \
    ...
    public:                                                                                     \
        static const bool value                                                                 \
            = impl<trait_name##_has_member<T, Signature>::value, Signature>::value;             \
