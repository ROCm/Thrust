...
namespace thrust
{
    ...
    namespace detail
    {
        ...
        // some metafunctions which check for the nested types of the adaptable
        // functions
        ...
        struct is_adaptable_unary_function
            : thrust::detail::and_<has_result_type<T>, has_argument_type<T>>
        {
        };
        ...
        template <typename T>
        struct is_commutative<typename thrust::multiplies<T>>
        ...
        template <typename T>
        struct is_commutative<typename thrust::logical_or<T>>
            : public thrust::detail::is_arithmetic<T>
        {
        };
        template <typename T>
        struct is_commutative<typename thrust::logical_and<T>>
            : public thrust::detail::is_arithmetic<T>
        {
        };
        template <typename T>
