    ...
    namespace detail
    {
        ...
        public:
            struct tail_flag_functor
            {
                ...
                __host__ __device__ tail_flag_functor(RandomAccessIterator first,
                ...
                __host__ __device__ __thrust_forceinline__ result_type
        ...
        public:
            ...
            __thrust_exec_check_disable__ __host__ __device__ tail_flags(RandomAccessIterator first,
                                                                         RandomAccessIterator last)
            ...
            __thrust_exec_check_disable__ __host__ __device__ tail_flags(
        ...
        __host__ __device__ tail_flags<RandomAccessIterator, BinaryPredicate> make_tail_flags(
            RandomAccessIterator first, RandomAccessIterator last, BinaryPredicate binary_pred)
        {
        ...
        template <typename RandomAccessIterator>
        __host__ __device__ tail_flags<RandomAccessIterator>
