    ...
    namespace detail
    {
        namespace functional
        {
            ...
            struct actor : Eval
            {
                ...
                __host__ __device__ actor(void);

                __host__ __device__ actor(const Eval& base);

                __host__ __device__ typename apply_actor<eval_type, thrust::null_type>::type
                         operator()(void) const;

                template <typename T0>
                __host__ __device__ typename apply_actor<eval_type, thrust::tuple<T0&>>::type
                         operator()(T0& _0) const;

                template <typename T0, typename T1>
                __host__ __device__ typename apply_actor<eval_type, thrust::tuple<T0&, T1&>>::type
                ...
                template <typename T0,
                          ...
                          typename T5>
                __host__ __device__
                    typename apply_actor<eval_type,
                                         thrust::tuple<T0&, T1&, T2&, T3&, T4&, T5&>>::type
                ...
                __host__ __device__
                    typename apply_actor<eval_type,
                                         thrust::tuple<T0&, T1&, T2&, T3&, T4&, T5&, T6&>>::type
                ...
                template <typename T0,
                          ...
                          typename T6,
                          typename T7>
                __host__ __device__ typename apply_actor<
                    eval_type,
                    thrust::tuple<T0&, T1&, T2&, T3&, T4&, T5&, T6&, T7&>>::type
                    operator()(
                        T0& _0, T1& _1, T2& _2, T3& _3, T4& _4, T5& _5, T6& _6, T7& _7) const;
                ...
                __host__ __device__ typename apply_actor<
                    eval_type,
                    thrust::tuple<T0&, T1&, T2&, T3&, T4&, T5&, T6&, T7&, T8&>>::type
                    operator()(
                ...
                __host__ __device__ typename apply_actor<
                    eval_type,
                    thrust::tuple<T0&, T1&, T2&, T3&, T4&, T5&, T6&, T7&, T8&, T9&>>::type
                    operator()(T0& _0,
                               T1& _1,
                               T2& _2,
                               T3& _3,
            ...
            template <typename T>
            typename as_actor<T>::type __host__ __device__ make_actor(const T& x)
            {
        ...
        // provide specializations for result_of for nullary, unary, and binary
        // invocations of actor
        template <typename Eval>
        struct result_of_adaptable_function<thrust::detail::functional::actor<Eval>()>
        {
            typedef typename thrust::detail::functional::
                apply_actor<thrust::detail::functional::actor<Eval>, thrust::null_type>::type type;
        }; // end result_of
