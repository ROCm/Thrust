...
namespace thrust
{
    ...
    template <typename T>
    __host__ __device__ inline complex<T> pow(const complex<T>& z, const complex<T>& exponent)
    {
 ...
 * function */
    template <>
    __host__ __device__ inline complex<double> pow(const complex<double>& z,
    ...
    __host__ __device__ inline complex<typename detail::promoted_numerical_type<T, U>::type>
             pow(const complex<T>& z, const complex<T>& exponent)
    {
    ...
    template <typename T, typename U>
    __host__ __device__ inline complex<typename detail::promoted_numerical_type<T, U>::type>
             pow(const complex<T>& z, const U& exponent)
    {
        typedef typename detail::promoted_numerical_type<T, U>::type PromotedType;
    ...
    template <typename T, typename U>
    __host__ __device__ inline complex<typename detail::promoted_numerical_type<T, U>::type>
             pow(const T& x, const complex<U>& exponent)
    {
        typedef typename detail::promoted_numerical_type<T, U>::type PromotedType;
