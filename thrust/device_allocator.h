 ...
 */
    template <typename T>
    class device_allocator : public device_new_allocator<T>
    {
    public:
        /*! The \p rebind metafunction provides the type of a \p device_allocator
   *  instantiated with another type.
   ...
   */
        __host__ __device__ inline device_allocator() {}

        /*! Copy constructor has no effect.
   */
        __host__ __device__ inline device_allocator(device_allocator const&) {}

        /*! Constructor from other \p allocator has no effect.
   */
        template <typename U>
        __host__ __device__ inline device_allocator(device_allocator<U> const&)
        {
        }
