 ...
 */
    ...
    __host__ __device__ inline typename access_traits<
        typename tuple_element<N, detail::cons<HT, TT>>::type>::non_const_type
 ...
 */
    ...
    __host__ __device__ inline
        typename access_traits<typename tuple_element<N, detail::cons<HT, TT>>::type>::const_type
        get(const detail::cons<HT, TT>& t);

    /*! \p tuple is a class template that can be instantiated with up to ten
 ...
 * instantiation of \p pair with the same two arguments. Individual elements of
 * a \p tuple may be accessed with the \p get function.
 *
 ...
 */
   ...
   */
    ...
    private:
        typedef typename detail::map_tuple_to_cons<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>::type
            inherited;
   ...
   */
    ...
    public:
        ...
        inline __host__ __device__ ~tuple() {}

        /*! \p tuple's no-argument constructor initializes each element.
   */
        inline __host__ __device__ tuple(void) {}

        /*! \p tuple's one-argument constructor copy constructs the first element from
   * the given parameter and intializes all other elements. \param t0 The value
   * to assign to this \p tuple's first element.
   */
        inline __host__ __device__ tuple(typename access_traits<T0>::parameter_type t0)
            : inherited(t0,
        ...
        /*! \p tuple's one-argument constructor copy constructs the first two elements
   * from the given parameters and intializes all other elements. \param t0 The
   * value to assign to this \p tuple's first element. \param t1 The value to
   * assign to this \p tuple's second element. \note \p tuple's constructor has
   * ten variants of this form, the rest of which are ommitted here for brevity.
   */
        inline __host__ __device__ tuple(typename access_traits<T0>::parameter_type t0,
   ...
   */
        ...
        inline __host__ __device__ tuple(typename access_traits<T0>::parameter_type t0,
            ...
            : inherited(
                t0, t1, t2, t3, t4, t5, t6, t7, t8, static_cast<const null_type&>(null_type()))
        {
        }
        ...
        inline __host__ __device__ tuple(const detail::cons<U1, U2>& p)
            : inherited(p)
        {
        }

        template <class U1, class U2>
        inline __host__ __device__ tuple& operator=(const detail::cons<U1, U2>& k)
        {
   ...
   * \p tuple from a \p pair. \param k A \p pair to assign from.
   */
        template <class U1, class U2>
 ...
 */
    template <class T0>
    __host__ __device__ inline typename detail::make_tuple_mapper<T0>::type
 ...
 */
    ...
    __host__ __device__ inline typename detail::make_tuple_mapper<T0, T1>::type
 ...
 */
    ...
    __host__ __device__ inline tuple<T0&> tie(T0& t0);
 ...
 */
    ...
    __host__ __device__ inline tuple<T0&, T1&> tie(T0& t0, T1& t1);
 ...
 */
    template <typename T0,
              ...
              typename U8,
              typename U9>
    inline __host__ __device__ void swap(tuple<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>& x,
 ...
 */
    ...
    __host__ __device__ inline typename detail::make_tuple_mapper<T0, T1, T2>::type
             make_tuple(const T0& t0, const T1& t1, const T2& t2);

    template <class T0, class T1, class T2, class T3>
    __host__ __device__ inline typename detail::make_tuple_mapper<T0, T1, T2, T3>::type
             make_tuple(const T0& t0, const T1& t1, const T2& t2, const T3& t3);

    template <class T0, class T1, class T2, class T3, class T4>
    __host__ __device__ inline typename detail::make_tuple_mapper<T0, T1, T2, T3, T4>::type
             make_tuple(const T0& t0, const T1& t1, const T2& t2, const T3& t3, const T4& t4);

    template <class T0, class T1, class T2, class T3, class T4, class T5>
    __host__ __device__ inline typename detail::make_tuple_mapper<T0, T1, T2, T3, T4, T5>::type
             make_tuple(
                 const T0& t0, const T1& t1, const T2& t2, const T3& t3, const T4& t4, const T5& t5);

    template <class T0, class T1, class T2, class T3, class T4, class T5, class T6>
    __host__ __device__ inline typename detail::make_tuple_mapper<T0, T1, T2, T3, T4, T5, T6>::type
             make_tuple(const T0& t0,
                        const T1& t1,
                        const T2& t2,
                        const T3& t3,
    ...
    __host__ __device__ inline tuple<T0&, T1&, T2&> tie(T0& t0, T1& t1, T2& t2);

    template <typename T0, typename T1, typename T2, typename T3>
    __host__ __device__ inline tuple<T0&, T1&, T2&, T3&> tie(T0& t0, T1& t1, T2& t2, T3& t3);

    template <typename T0, typename T1, typename T2, typename T3, typename T4>
    __host__ __device__ inline tuple<T0&, T1&, T2&, T3&, T4&>
             tie(T0& t0, T1& t1, T2& t2, T3& t3, T4& t4);

    template <typename T0, typename T1, typename T2, typename T3, typename T4, typename T5>
    __host__ __device__ inline tuple<T0&, T1&, T2&, T3&, T4&, T5&>
    ...
    template <typename T0,
              ...
              typename T5,
              typename T6>
    __host__ __device__ inline tuple<T0&, T1&, T2&, T3&, T4&, T5&, T6&>
    ...
    template <typename T0,
              ...
              typename T6,
              typename T7>
    __host__ __device__ inline tuple<T0&, T1&, T2&, T3&, T4&, T5&, T6&, T7&>
    ...
    template <typename T0,
              ...
              typename T7,
              typename T8>
    __host__ __device__ inline tuple<T0&, T1&, T2&, T3&, T4&, T5&, T6&, T7&, T8&>
    ...
    template <typename T0,
              ...
              typename T8,
              typename T9>
    __host__ __device__ inline tuple<T0&, T1&, T2&, T3&, T4&, T5&, T6&, T7&, T8&, T9&>
